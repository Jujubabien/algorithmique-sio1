...
TIMEOUT=1000    # Time for word input.

NVLET=7      # 10 letters for non-vulnerable.
...
m n a n o v n w o s e l n à è é â ê ô î ï ö o s p a q e e r a b r s a o d s
